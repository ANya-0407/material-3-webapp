//EditVoicesProfileFormコンポーネントを作成

import styles from 'src/styles/EditVoicesProfileForm.module.css'
...
const EditVoicesProfileForm: React.FC = () => {
    ...
    return (
        <>
            <div className={styles.edit_voices_profile_form_wrapper}>
...
export default EditVoicesProfileForm;
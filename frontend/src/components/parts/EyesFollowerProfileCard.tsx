//EyesFollowerProfileCardコンポーネントを作成

import { EyesFollowProfileProps } from "src/types";
import styles from 'src/styles/EyesFollowerProfileCard.module.css'
...
type EyesFollowerProfileCardProps = {
    profile: EyesFollowProfileProps;
};


const EyesFollowerProfileCard: React.FC<EyesFollowerProfileCardProps> = ({ profile }) => {
    // ルーター
    ...
    return (
        <>
            <div className={styles.eyes_follower_profile_card_background}>
...
export default EyesFollowerProfileCard;
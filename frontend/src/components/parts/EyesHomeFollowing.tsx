...
const EyesHomeFollowing: React.FC = () => {
    //画面サイズの判定
    ...
    return (
        <>
            <div className={styles.eyes_home_following_wrapper}>
...
export default EyesHomeFollowing;
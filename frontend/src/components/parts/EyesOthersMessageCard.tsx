//EyesOthersMessageCardコンポーネントを作成

import { EyesMessageProps } from "src/types";
import styles from 'src/styles/EyesOthersMessageCard.module.css'
import React, { useState, useRef, useEffect } from "react";
import { useRouter } from "next/router";
import Image from "next/image";


type EyesOthersMessageCardProps = {
...
const OthersMessageCard: React.FC<EyesOthersMessageCardProps> = ({ message }) => {
    //ルーター
    ...
    //画像のalt
    const iconAlt = `Icon Image: ${message.sender.accountName}`;
    ...
    const goEyesProfile = () => {
        router.push(
            { pathname: '/eyesprofile/[id]', query: { id: message.sender.accountId } },
        );
    };

    return (
        <>
            <div className={styles.eyes_others_message_card_wrapper}>
                <div className={styles.sender_icon_wrapper} onClick={goEyesProfile}>
                    <Image
                        className={styles.sender_icon}
                        src={message.sender.accountIcon}
                        alt={iconAlt}
                        fill
                        priority={false}
                    />
...
export default OthersMessageCard;
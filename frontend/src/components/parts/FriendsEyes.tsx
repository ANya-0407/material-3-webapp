...
const FriendsEyes: React.FC<MainEyesProps> = ({ eyes }) => {
    // 投稿の状態管理（センターカラムのみ使用）
    ...
    return (
        <>
            <div className={styles.friends_eyes_wrapper} ref={centerColumnRef}>
                {(eyes !== undefined && eyes !== null) &&
                    <>
                    <span className={styles.title}>Friends{" "}<p><FontAwesomeIcon icon={faUserGroup} /></p></span>

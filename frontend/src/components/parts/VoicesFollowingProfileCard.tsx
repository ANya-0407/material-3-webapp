//VoicesFollowingProfileCardコンポーネントを作成

import { VoicesFollowProfileProps } from "src/types";
import styles from 'src/styles/VoicesFollowingProfileCard.module.css'
...
type VoicesFollowingProfileCardProps = {
    profile: VoicesFollowProfileProps;
};


const VoicesFollowingProfileCard: React.FC<VoicesFollowingProfileCardProps> = ({ profile }) => {
    // ルーター
    ...
    return (
        <>
            <div className={styles.voices_following_profile_card_background}>
...
export default VoicesFollowingProfileCard;
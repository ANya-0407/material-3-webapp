//VoicesProfileVoicesコンポーネントを作成

import VoicesCard, { VoicesProps } from 'src/components/parts/VoicesCard';
import styles from 'src/styles/VoicesProfileCloud.module.css'
...
const VoicesProfileVoices: React.FC = () => {
    //画面サイズの判定
    ...
    return (
        <>
            <div className={styles.voices_profile_voices_wrapper}>
...
export default VoicesProfileVoices;
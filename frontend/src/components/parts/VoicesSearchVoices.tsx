//VoicesSearchVoicesコンポーネントを作成

import VoicesCard, { VoicesProps } from 'src/components/parts/VoicesCard';
import styles from 'src/styles/VoicesSearchVoices.module.css'
...
const VoicesSearchVoices: React.FC = () => {
    //画面サイズの判定
    ...
    return (
        <>
            <div className={styles.voices_search_voices_wrapper}>
...
export default VoicesSearchVoices;